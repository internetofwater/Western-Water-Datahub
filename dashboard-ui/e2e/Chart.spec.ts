...
test.describe('Line Chart', () => {
    test('should handle load and change to 5 years', async ({ page }) => {
        ...
        await test.step('Load chart at 1 year range', async () => {
            ...
            const url = `https://cache.wwdh.internetofwater.app/collections/rise-edr/locations/3514?parameter-name=Storage&datetime=${dateRange.startDate}/..`;
        ...
        await test.step('Request is made after change to 5 years', async () => {
            ...
            const url = `https://cache.wwdh.internetofwater.app/collections/rise-edr/locations/3514?parameter-name=Storage&datetime=${dateRange.startDate}%2F`;
