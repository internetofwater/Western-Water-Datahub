...
const Screenshot: React.FC = () => {
  return (
    <svg
      ...
      aria-labelledby="icon-title-screenshot icon-desc-screenshot"
    >
      <title id="icon-title-screenshot">Screenshot Menu</title>
      <desc id="icon-desc-screenshot">
        This icon is used in a button to open the screenshot menu
      </desc>
      <g
        id="Page-1"
        stroke="none"
