...
describe('NotificationManager', () => {
  ...
  test('should show a notification and add it to the store', () => {
    const id = notificationManager.show('Test message', ENotificationType.Info, 1000);
  ...
  test('should hide a notification and remove it from the store', () => {
    const id = notificationManager.show('Hide me', ENotificationType.Info, 1000);
  ...
  test('should pause and resume a notification timer', () => {
    ...
    const id = notificationManager.show('Pause me', ENotificationType.Info, 3000);
