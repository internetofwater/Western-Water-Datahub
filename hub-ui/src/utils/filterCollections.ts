...
//     filterFunctions.push((collection) =>
//       categoryMembers.includes(collection.id),
//     );
//   }

//   if (provider && provider.length > 0) {
//     filterFunctions.push(
//       (collection) => getProvider(collection.id) === provider,
//     );
//   }
...
//         filterFunctions.every((filter) => filter(collection)),
//     )
