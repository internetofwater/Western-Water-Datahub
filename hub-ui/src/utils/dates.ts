...
const getSimplePresetDate = (
  simplePreset: DatePreset,
  ...
  switch (simplePreset) {
    ...
    case DatePreset.FiveYears:
      return {
        value: dayjs().subtract(5, "year").format("YYYY-MM-DD"),
        label: "Five years",
      };
    case DatePreset.TenYears:
      return {
        value: dayjs().subtract(10, "year").format("YYYY-MM-DD"),
        label: "Ten years",
      };
    case DatePreset.FifteenYears:
      return {
        value: dayjs().subtract(15, "year").format("YYYY-MM-DD"),
        label: "Fifteen years",
      };
    case DatePreset.ThirtyYears:
      return {
        value: dayjs().subtract(30, "year").format("YYYY-MM-DD"),
        label: "Thirty years",
      };
  }
};
