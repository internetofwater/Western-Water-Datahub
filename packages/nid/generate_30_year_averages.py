...
from nid.lib import StaticDataOutput
...
reservoirToDayOfMonthAndValues: StaticDataOutput = {}
...
for _, station in usace_stations.iterrows():
    ...
    for date_group, group in filteredCsv.groupby("month_and_day"):
        if associatedNidId not in reservoirToDayOfMonthAndValues:
            reservoirToDayOfMonthAndValues[associatedNidId] = {
                "grandID": grand_id,
                "longitude": station["LONG"],
                "latitude": station["LAT"],
                "name": dam_name,
                "agencyCode": station["AGENCY_CODE"],
            }
